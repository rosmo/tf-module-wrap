...
variable "net_address" {
  type = object({
    ...
    ipsec_interconnect_addresses = map(object({
      region        = string
      address       = string
      network       = string
      description   = optional(string, "Terraform managed.")
    ...
    network_attachments = map(object({
